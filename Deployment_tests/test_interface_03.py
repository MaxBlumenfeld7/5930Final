...
instruct_model_id = "HuggingFaceTB/SmolLM2-135M-instruct"

base_tokenizer = AutoTokenizer.from_pretrained(base_model_id)
instruct_tokenizer = AutoTokenizer.from_pretrained(instruct_model_id)

base_model = AutoModelForCausalLM.from_pretrained(base_model_id)
instruct_model = AutoModelForCausalLM.from_pretrained(instruct_model_id)
...
with gr.Blocks() as demo:
    ...
    gr.Markdown("Compare responses between base and instruction-tuned versions of SmolLM2-135M")
